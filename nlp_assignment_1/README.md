...
Software Requirement Specifications (SRS) are crucial in defining what a system should do.
However, ambiguous language — especially passive voice and conditional modal verbs (like could, might, should, would) — makes requirements unclear and hard to test.
...
Such usage weakens requirement enforceability (e.g., “The system should allow login.” → “The system shall allow login.”).
...
Example prompt:
    "Rewrite the following sentence into active voice:
    'The data shall be processed by the system.'"
...
Some sentences lack explicit agents (e.g., “The system shall be used.”)	
    Use contextual AI rewriting to infer agent
Limited to English text	
    Extend to multilingual NLP
Works on static files	
    Extend for live document editors

11. Conclusion

This project successfully applies Natural Language Processing techniques to detect and improve the linguistic quality of SRS documents.
By combining dependency parsing with AI-based rewriting, we bridge the gap between linguistic correctness and requirement clarity — ensuring that specifications are unambiguous, testable, and implementation-ready.
